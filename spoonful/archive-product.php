...
if ($queried_object instanceof WP_Term) {
    ...
    } elseif ($queried_object->taxonomy === 'product_tag') {
        // It's a tag
        $tag_name = $queried_object->slug;
    ...
    // Default case if $queried_object is not available
    $args = array(
        'post_type'      => 'product',
        'posts_per_page' => 12,
        'paged'          => max(1, get_query_var('paged')),
