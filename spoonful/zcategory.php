    ...
    <div class=container>
        <div class=row>
            <div class="col-md-12 text-center caption mt-60">
                <h5>
                    Order Now</h5>
                <h1><?php // Output category name for debugging
                    echo '<pre>';
                ...
                <div class=shop-sidebar>
                    <div id=woocommerce_product_search-2 class="widget item woocommerce widget_product_search">
                        <div class="form search">
                            <form role="search" method="get" class="woocommerce-product-search form-group" action="<?php echo esc_url(home_url('/')); ?>">
                    ...
                    <div id="woocommerce_product_tag_cloud-2" class="widget item woocommerce widget_product_tag_cloud">
                        ...
                        <div class="tagcloud">
                            <?php
                            $tags = get_terms('post_tag', 'orderby=name');
                            if ($tags && !is_wp_error($tags)) :
                                foreach ($tags as $tag) :
                            ?>
                                    <a href="<?php echo get_term_link($tag); ?>" class="tag-cloud-link tag-link-<?php echo esc_attr($tag->term_id); ?>" style="font-size: <?php echo esc_attr($tag->count * 2); ?>pt;" aria-label="<?php echo esc_attr($tag->name); ?> (<?php echo esc_attr($tag->count); ?> products)">
